...
This chapter contains information that you need to know to combat global warming. The first step is to learn about what the sources of the gases are about, then start to take action where you can by addressing your own carbon footprint.
